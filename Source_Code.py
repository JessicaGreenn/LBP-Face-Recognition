...
subjects = ['', 'SICHUN MA', 'LIQI', 'LAMUYANGZI', 'ZDY']
...
# bjt and gj
# test_img1 = cv2.imread("test-data/test5.jpeg")
test_img1 = cv2.imread("test-data/test4.jpeg")
#test_img3 = cv2.imread("test-data/test6.jpeg")
test_img2 = cv2.imread('test-data/test8.jpg')
test_img3 = cv2.imread('test-data/test10.jpg')
...
#     predicted_imgs.append(predict(test_img))
...
#display both images
# for sub in subjects:
#     cv2.imshow(sub,cv2.resize())
# for sub_i in range(len(subjects)):
    # cv2.imshow(subjects[sub_i],cv2.resize(predicted_imgs[sub_i],(400,500)))
# cv2.imshow(subjects[1], cv2.resize(predicted_img1, (400, 500)))
cv2.imshow(subjects[1], cv2.resize(predicted_img1, (400, 500)))
# cv2.imshow(subjects[2], cv2.resize(predicted_img3, (400, 500)))
cv2.imshow(subjects[3], cv2.resize(predicted_img2, (400, 500)))
cv2.imshow(subjects[4], cv2.resize(predicted_img3, (400, 500)))
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.waitKey(1)
cv2.destroyAllWindows()
